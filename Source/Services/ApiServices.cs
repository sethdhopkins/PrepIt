...
namespace Source.Services
{
    ...
    public class  Program
    {
        public static void Run(string[] args)
        {
            ...
            api.GetIngredients(api.apiResult);
        }
    }
